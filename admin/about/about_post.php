...
if(isset($_POST['submit'])){
    $titile=test_input($_POST['titile']);
    ...
    $photo=$_FILES['photo'];
    if(empty($titile)){
        $_SESSION['titilerr']="Enter Your Title";
    }
    if(empty($photo['name'])){
    ...
    if(!empty($photo['name'])){
       ...
       if( $upload){
        $qurey="INSERT INTO aboutsection (title,discription_one,list_one,list_two,list_three,discription_two,photo) VALUES ( '$titile','$discription_one','$list_one','$list_two','$list_three','$discription_two','$photoname')";
